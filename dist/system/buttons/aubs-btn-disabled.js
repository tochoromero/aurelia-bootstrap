...
System.register(['aurelia-framework'], function (_export, _context) {
    ...
    var inject, _dec, _class, AubsBtnDisabledCustomAttribute;
    ...
    return {
        ...
        execute: function () {
            _export('AubsBtnDisabledCustomAttribute', AubsBtnDisabledCustomAttribute = (_dec = inject(Element), _dec(_class = function () {
